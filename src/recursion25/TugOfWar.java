...
public class TugOfWar
    {
                     ...
                     int sum, int curr_sum, int curr_position)
        {
            ...
            if ((n / 2 - no_of_selected_elements) >
                    (n - curr_position))
                return;
  // When the if condition turns invalid it means that
  // we are already having the required no of element to
  // form the subset.
            ...
            if (no_of_selected_elements == n / 2)
            {
                ...
                // 120 & 121 to get there we must explore all
                // the possiblites. This would be the case for any
                // two no's.
